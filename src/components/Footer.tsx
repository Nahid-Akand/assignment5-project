...
export default function Footer() {
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute -right-32 -top-32 h-72 w-72 rounded-full bg-pink-200/30 blur-3xl" />

      <div className="pointer-events-none absolute -bottom-32 -left-32 h-72 w-72 rounded-full bg-violet-200/20 blur-3xl" />
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-14 lg:px-8 lg:py-16">
          ...
          <div>
            ...
            <div className="mt-6 flex items-center gap-3">
              ...
              <a
                ...
                rel="noreferrer"
                aria-label="GitHub"
                className="flex h-9 w-9 items-center justify-center rounded-full border border-slate-200 bg-white text-slate-500 shadow-sm transition-all duration-200 hover:-translate-y-1 hover:border-[#EC4899] hover:text-[#EC4899] hover:shadow-md"
              >
                <svg
            ...
            <ul className="mt-5 space-y-3">
              {productLinks.map((link) => (
                <li key={link.label}>
                  <a
                    href={link.href}
                    className="group flex w-fit items-center text-sm text-slate-500 transition-colors duration-200 hover:text-[#EC4899]"
                  >
        ...
        <div className="mt-14 flex flex-col gap-4 border-t border-slate-200 pt-6 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-6">
            <a
              href="#privacy"
              className="text-xs text-slate-400 transition-colors duration-200 hover:text-[#EC4899]"
            >
              Privacy
            </a>
